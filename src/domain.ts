...
export type SyncRoom = { id: string; groupId: string; groupName: string; teacherId: string; teacherName: string; title: string; status: "open" | "closed"; createdAt: string; currentQuestion?: SyncRoomQuestion | null };
