...
export function App() {
  ...
  useEffect(() => {
    if (page !== "studio-room" || studioMode !== "live" || studioExitPage !== "class-groups" || !activeQuestionId || !activeSyncRoomId) return;
    void teachingRepository.updateSyncRoomQuestion(activeSyncRoomId, activeQuestionId).catch((cause) => {
      setError(cause instanceof Error ? cause.message : "同步当前题目失败");
    });
  }, [activeQuestionId, activeSyncRoomId, page, studioExitPage, studioMode]);
    ...
    <div className="teacher-auth">
      <section className="auth-story">
        <div className="auth-brand">
          ...
          <strong>{role === "student" ? "知问课堂" : "Teacher Agent"}</strong>
        </div>
        <div>
        ...
        <small>© 2026 Teacher Agent · 专业教学内容平台</small>
      </section>
