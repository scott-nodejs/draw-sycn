...
-- ============================================================
-- 笔尖云堂第一阶段收口：仅保留系统管理与租户管理
-- ============================================================

-- 应用边界初始化：平台后台与租户后台共用 ADMIN，老师端与学生端独立。
...
ALTER TABLE sys_menu ADD COLUMN app_id bigint(20) NOT NULL DEFAULT 1 COMMENT '所属应用ID' AFTER menu_id;
ALTER TABLE sys_menu ADD KEY idx_sys_menu_app_id (app_id);
ALTER TABLE sys_role ADD COLUMN app_id bigint(20) NOT NULL DEFAULT 1 COMMENT '所属应用ID' AFTER role_id;
ALTER TABLE sys_role ADD KEY idx_sys_role_app_id (app_id);
...
SELECT '000000', 1, menu_id, 'INIT', 1, NOW() FROM sys_menu;
