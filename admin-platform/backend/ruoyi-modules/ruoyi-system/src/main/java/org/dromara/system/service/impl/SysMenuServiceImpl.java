...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<SysMenuVo> selectMenuList(Long userId) {
        ...
        menu.setAppId(AppConstants.ADMIN_ID);
    ...
    public List<SysMenuVo> selectMenuList(SysMenuBo menu, Long userId) {
        ...
        menuList = baseMapper.selectVoList(
            wrapper.eq(ObjectUtil.isNotNull(menu.getAppId()), SysMenu::getAppId, menu.getAppId())
    ...
    public List<SysMenu> selectMenuTreeByUserId(Long userId) {
        ...
        if (LoginHelper.isSuperAdmin(userId)) {
            menus = baseMapper.selectList(new LambdaQueryWrapper<SysMenu>()
                .eq(SysMenu::getAppId, AppConstants.ADMIN_ID)
