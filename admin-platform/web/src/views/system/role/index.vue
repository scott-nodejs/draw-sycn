  ...
  <div class="p-2">
        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="所属应用" prop="appId">
              <el-select v-model="queryParams.appId" placeholder="全部应用" clearable style="width: 150px">
    ...
    <el-card shadow="hover">
      ...
      <el-table ref="roleTableRef" border v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="所属应用" prop="appId" align="center" width="120">
          <template #default="scope">
            <el-tag :type="scope.row.appId === 1 ? 'primary' : scope.row.appId === 2 ? 'success' : 'warning'">
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" width="500px" append-to-body>
      <el-form ref="roleFormRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="所属应用" prop="appId">
          <el-select v-model="form.appId" placeholder="请选择角色所属应用" style="width: 100%" :disabled="!!form.roleId" @change="handleAppChange">
            <el-option v-for="item in appOptions" :key="item.value" :label="item.label" :value="item.value">
...
const appOptions = [
  { value: 1, label: '管理后台', description: '平台与机构管理' },
  { value: 2, label: '老师端', description: '老师业务应用' },
  { value: 3, label: '学生端', description: '学生业务应用' }
];
const getAppName = (appId: string | number) => appOptions.find((item) => String(item.value) === String(appId))?.label || '管理后台';
...
const getMenuTreeselect = async () => {
  const res = await menuTreeselect({ appId: form.value.appId });
