...
.paper-workspace{height:calc(100vh - 205px);min-height:560px}.preview-canvas{min-height:0;overflow:hidden;align-items:center;padding:18px}.preview-canvas>img{width:auto;height:auto;max-width:100%;max-height:100%;object-fit:contain}
</style>
