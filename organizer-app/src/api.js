...
export const api = {
    ...
    processing: (id) => request(`/papers/${encodeURIComponent(id)}/processing`), retry: (id) => request(`/papers/${encodeURIComponent(id)}/processing/retry`, { method: 'POST' }), pause: (id) => request(`/papers/${encodeURIComponent(id)}/processing/pause`, { method: 'POST' }), resume: (id) => request(`/papers/${encodeURIComponent(id)}/processing/resume`, { method: 'POST' }), confirmedQuestions: () => request('/organizer/questions'),
    splitPage: (id, pageNumber) => request(`/papers/${encodeURIComponent(id)}/processing/pages/${pageNumber}/split`, { method: 'POST' }),
    ...
    enhanceFigure: (id, index) => request(`/questions/${encodeURIComponent(id)}/figures/${index}/enhance`, { method: 'POST' }),
    replaceFigure: (id, index, file) => { const body = new FormData(); body.append('file', file); return request(`/questions/${encodeURIComponent(id)}/figures/${index}`, { method: 'PUT', body }); },
